    ...
    <div className="container mx-auto px-4 md:px-0 mt-8 min-h-screen flex flex-col md:flex-row">
      <div className="bg-white shadow-md rounded-lg p-8 w-full mb-8 md:mb-0 overflow-auto">
        ...
        <p className="text-gray-600 text-lg leading-relaxed">
          ...
          Shears and moments due to different loading conditions are determined
          by many methods such as portal method, moment distribution method and
          matrix method.
          <br />
          ...
          transportation need also increases. These factors support the vertical
          development of the buildings. Further with the advent of newer
          building materials, vertical developments have become more common in
          cities. A multistoried building is basically a frame formed structure.
          In a multistoried frame all members are continuous. Hence, economical
          construction is possible. The earthquake forces are distributed
          effectively as the whole structure behaves as one unit.
          <br />
          Clearly, buildings are composed of various structure elements such as
          slabs, beams, columns, and footings. Each of these structural members
          play certain role in a structure. This article presents various
          aspects of these structural members for instance their function, types
          of loads imposed on them, and load transfer mechanism from one member
          to another one.
          <br />
        </p>
        <br />
