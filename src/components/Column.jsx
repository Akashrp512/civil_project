    ...
    <div className="flex flex-col md:flex-row mt-2">
      <div className="bg-white shadow-md rounded-lg p-8 w-full lg:w-2/3 mx-auto md:mx-0 md:w-1/3">
        ...
        <p className="text-gray-600 text-lg leading-relaxed">
          ...
          said to be under uniaxial bending. On the other hand, a corner column
          of a building is subjected to eccentric load along both the X and Y
          axes. Such columns are said to be under biaxial bending.
        </p>
      </div>
