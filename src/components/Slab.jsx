      ...
      <div className="flex flex-col md:flex-row mt-2">
        <div className="bg-white shadow-md rounded-lg p-8 w-full lg:w-2/3 mx-auto md:mx-0 md:w-1/3">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            create flat and useful surfaces such as floors, roofs, and ceilings.
            It is a horizontal structural component, with top and bottom
            surfaces parallel or near so. To read more about slab thickness
            evaluation please click here . Commonly, slabs are supported by
            beams, columns (concrete or steel), walls, or the ground. The depth
          ...
          <div className="space-y-4">
            <div className="space-y-4 md:space-y-1 md:space-x-4 flex flex-col md:flex-row bg-slate-100 p-3 rounded-md border border-gray-700 border-separate">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">
                  Xu,Max/d :{" "}
                  <span className="text-base font-normal">{XU_MAX_RATIO}</span>
                </p>
              </div>
            </div>
